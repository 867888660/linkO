...
FunctionIntroduction = (
    '组件功能（简述代码整体功能）\n'
    '这是一个数据库搬迁节点：把源 SQLite 数据库中的 polyMarket_Monitor 表搬迁到目标 SQLite 数据库中。\n\n'
    '代码功能摘要（概括核心算法或主要处理步骤）\n'
    '节点接收源库路径与目标库路径，连接两个 SQLite 数据库；检查源库是否存在 polyMarket_Monitor 表；'
