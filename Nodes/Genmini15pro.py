...
def run_node(node):
    ...
    payload = json.dumps({
        "model": "gemini-2.0-flash-thinking-exp-1219",  # Updated model
    ...
    headers = {
        ...
        'Authorization': 'Bearer sk-ZgAhIijN04ad9b42xndwbYZhcS2BWsseELGRgGgG25wcsQFh',  # Update with your actual token
        'User-Agent': 'Apifox/1.0.0 (https://apifox.com)',
        'Content-Type': 'application/json'
    }

    # Updated to use requests instead of http.client
